...
export class News extends Component {
    ...
    async componentDidMount() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=02b0f812bd0d4aec92965bbb5b45ff16&page=1&pageSize=${this.props.pageSize}`
    ...
    handlePrevClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=02b0f812bd0d4aec92965bbb5b45ff16&page=${this.state.page - 1}&pageSize=${this.props.pageSize} `
        this.setState({ loading: true })
        let data = await fetch(url);
        let parsedData = await data.json()
        console.log(parsedData);
    ...
    render() {
        ...
        return (
            ...
            <div className='container my-3'>
                <h1 className='text-center '>NewsInsider - Top Headlines</h1><hr />
